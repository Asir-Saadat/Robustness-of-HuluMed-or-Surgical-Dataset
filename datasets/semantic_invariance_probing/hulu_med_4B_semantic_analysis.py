#!/usr/bin/env python3
"""
Hulu-Med-4B semantic variations analysis script for Cholec80 dataset.
...
# Save to JSON
output_path = '/home/as5606/Datasets/Cholec_text_semantic_similar_questions/hulu_med_4B_semantic_variations_answers.json'
